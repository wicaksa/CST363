-- assignment 2a schema
-- product table lists all models along with the maker (manufactuerer) and 
--    the product type ('pc', 'laptop', or 'printer')
-- pc table has additional information for each pc models
-- laptop, additional information for laptop models
-- printer, additional information for printer models
